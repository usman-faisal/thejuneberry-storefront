    ...
    <Layout className="pt-30 pb-20 md:pt-47 md:pb-32">
      ...
      >
        <h1 className="text-lg md:text-2xl mb-16 md:mb-25">
          Terms of Use for The Juneberry
        </h1>
      </LayoutColumn>
      <LayoutColumn
        start={{ base: 1, lg: 2, xl: 3 }}
      ...
      >
        <p>
          Welcome to The Juneberry. These Terms of Use govern your access to and
        ...
        <p>
          To the maximum extent permitted by law, The Juneberry and its
        ...
        <p>
          You agree to indemnify, defend, and hold harmless The Juneberry and its
        ...
        <p>
          ...
          at our sole discretion. Your continued use of our website after any
          such changes constitute your acceptance of the new Terms of Use.
        </p>
